...
export function Page() {
    ...
    return (
        <div className="bg-my-gray-600 w-screen flex flex-col items-center grow font-inter">
            ...
            <div className="mt-16 w-content-w min-h-72 flex-1">
                <div className="flex justify-between mb-6 font-bold">
                    ...
                    <p className="flex gap-2 text-purple">Completed
                        <span className="text-white bg-my-gray-400 px-2 rounded-full">{tasksChecked.length != 0? `${tasksChecked.length} of ${tasks.length}`: '0'}</span>
                    </p>
                </div>
                <div>
